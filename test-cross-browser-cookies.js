// Test Script for Cross-Browser Cookie Compatibility
// This script verifies that cookies are properly set and can be sent back by all browsers
// Including iOS Safari, Chrome, Firefox, etc.
...
// CORS configuration that mimics production for cross-browser testing
...
// Test endpoint to set cookies with cross-browser compatible attributes
app.get('/set-test-cookie', (req, res) => {
  // Set a test cookie with cross-browser compatible attributes
  ...
  console.log('=== CROSS-BROWSER COOKIE DEBUG ===');
...
// Enhanced CORS headers middleware for testing
...
app.listen(PORT, () => {
  console.log(`Cross-Browser Cookie Test Server running on port ${PORT}`);
